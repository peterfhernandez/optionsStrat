...
def strangle_state(future_expiry):
    ...
    return {
        "open": {
            ...
            "days":            7,
            "asset":           "ETH",
            "put_instrument":  "ETH-23MAY26-1800-P",
            "call_instrument": "ETH-23MAY26-2200-C",
        },
        "wins":          0,
        "losses":        0,
        "trades":        1,
    ...
    def test_calendar_stop_loss_calls_broker(self, today_expiry):
        ...
        state = {
            "open": {
                ...
                "spot_open":       2000.0,
                "asset":           "ETH",
                "near_instrument": "ETH-TODAY-2000-C",
                "far_instrument":  "ETH-FAR-2000-C",
            },
